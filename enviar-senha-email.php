<?
$connect = mysql_connect('localhost','amais','amaispower');
$db = mysql_select_db('celebration');
$query_select = "SELECT corretores FROM celebration WHERE login = '$login'";
...
if ( $contagem == 1 ) {
  ...
  $Remetente = "celebration@celebrationville.com.br"; //remetente do email, coloque o email do seu site
