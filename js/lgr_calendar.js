    ...
    $.fn.ical = function(options){
        ...
        */
        function createNavigation(obj, insdate){
            obj.append("<div><div id = 'currentmonth' class='"+ (insdate.getMonth()+1) +"'>"+ options.monthnames[insdate.getMonth()] +"</div> <div id = 'currentyear'>"+ insdate.getFullYear() +"</div> <div id='icalnav'><a id ='icalprev'><</a><a id ='icalnext'>></a></div></div>");
